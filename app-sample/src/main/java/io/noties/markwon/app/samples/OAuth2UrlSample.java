...
public class OAuth2UrlSample extends MarkwonTextViewSample {
  ...
  public void render() {
    ...
    // Note: This is intentionally a single long line to demonstrate that LinkifyPlugin
    // correctly handles real-world OAuth URLs without truncation or parsing issues.
    // The URL contains a redirect_uri parameter with a custom scheme (com.theguardian.oauth://)
    final String md = "" +
      "# OAuth2 URL Test\n\n" +
      "Guardian OAuth URL:\n\n" +
      ...
      "This URL should be clickable and fully preserved by LinkifyPlugin.\n";
